...
function save_issues_API(URL, local_key, current_page, first_item){
    ...
    let apidata = "https://api.github.com/search/issues?q=repo:" + input + "+type:issue+closed:>" + date + "&per_page=100&page=" + current_page + "&access_token=1e4c54a97e4913272325ed71e84e916041795b4e";
